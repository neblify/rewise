...
describe('Student Profile Actions', () => {
    ...
    describe('updateProfile', () => {
        ...
        it('should update profile successfully', async () => {
            ...
            (User.findOneAndUpdate as any).mockResolvedValue({ clerkId: 'user_123', board: 'CBSE' });
        ...
        it('should handle database errors', async () => {
            ...
            (User.findOneAndUpdate as any).mockRejectedValue(new Error('DB connection failed'));
