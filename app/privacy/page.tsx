      ...
      <div className="bg-card px-6 py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-base leading-7 text-muted-foreground">
          ...
          <div className="prose max-w-none space-y-8">
            ...
            <p>
              This policy applies to all visitors, users, and others who access
              or use the ReWise website and any related services (collectively,
              the &quot;Service&quot;).
            </p>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              <li>
                Name, email address, or phone number (if you contact us, submit
                a form, or sign up for updates/newsletter)
              </li>
            ...
            <p>
              ...
              13 (or the relevant age in your country). If we become aware we
            ...
            <p className="mt-4">
              ...
              advertising, profiling for commercial purposes, or selling
              personal data.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              ...
              <li>
                ...
                usage (usually anonymized)
              </li>
            </ul>
            <p className="mt-4">
              You can control cookies through your browser settings. Most
              browsers allow you to refuse cookies or alert you when one is
              placed. Note that disabling cookies may limit some features.
            </p>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              ...
              <li>
                Analytics data → usually kept 14–26 months (depending on
                provider settings)
              </li>
              <li>
                Automatically deleted when no longer needed or upon request
                (where applicable)
              </li>
            </ul>
            ...
            <p>
              We do not respond to &quot;Do Not Track&quot; browser signals as
            ...
            <p>
              ...
              EU-based Vercel regions]. If you access the Service from outside
              the hosting region, your information may be transferred to and
              processed in other countries. We ensure appropriate safeguards are
              in place for such transfers where required.
            </p>
            ...
            <p>
              Significant changes will be communicated via a notice on the
              website (if feasible).
            </p>
