                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                    <div className="sm:max-w-lg">
                        ...
                        >
                            ...
                            <p className="mt-4 text-xl text-gray-500">
                                Personalized learning for Students, smart tools for Teachers, and
                                insights for Parents. The all-in-one platform for NIOS success.
                            </p>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className="mt-10 md:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                        ...
                        >
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-50 rounded-full blur-3xl opacity-50" />
                            <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-blue-50 rounded-full blur-3xl opacity-50" />
                            ...
                            <div className="relative flex justify-center items-center h-full">
                                ...
                                <div className="relative bg-white/80 backdrop-blur-md p-6 rounded-2xl shadow-2xl border border-gray-100 max-w-md w-full mx-4">
                                    <div className="flex items-center border-b border-gray-100 pb-4 mb-4">
                                        ...
                                        <div className="ml-3">
                                            <div className="text-sm font-semibold text-gray-900">Psychology Test</div>
                                            <div className="text-xs text-gray-500">AI Analysis in progress...</div>
                                        </div>
                                    </div>
