                        ...
                        <div className="flex gap-4">
                          <div className="flex-1">
                            <textarea
                              ...
                              className="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900"
                          ...
                          <div className="w-1/4">
                            <select
                              ...
                              className="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900 bg-white"
                            >
                          ...
                          <div className="grid grid-cols-2 gap-2 bg-gray-50 p-3 rounded-md">
                            {q.options.map((opt: string, optIndex: number) => (
                              <input
                                ...
                                className="block w-full rounded border-gray-200 text-sm text-gray-900"
                            ...
                            <input
                              ...
                              className="col-span-2 block w-full rounded border-green-200 bg-green-50 text-sm placeholder-green-600 text-gray-900"
