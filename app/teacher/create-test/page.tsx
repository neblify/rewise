...
function CreateTestPageContent() {
  ...
  const removeQuestionExp = (secIndex: number, qIndex: number) => {
    ...
    newSecs[secIndex].questions = newSecs[secIndex].questions.filter(
      (_: QuestionState, i: number) => i !== qIndex
    );
    setSections(newSecs);
  };
        ...
        <form action={handleSubmit} className="space-y-8">
          ...
          {mode === 'ai' && (
            <div className="rounded-xl bg-card p-6 shadow-sm border border-border space-y-6">
              ...
              <p className="text-sm text-muted-foreground">
                Set topic and options below, then click{' '}
                <strong>Generate Test</strong> to create questions.
              </p>
              <div className="grid gap-6 md:grid-cols-2">
                <div className="col-span-2">
                  <label
          ...
          {mode === 'ai' && !hasGeneratedContent && (
            <p className="text-muted-foreground text-sm pt-4">
              Fill in the &quot;Generate test with AI&quot; section above and
              click <strong>Generate Test</strong>, then review and publish
              below.
            </p>
          )}
        </form>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              The previously generated test will be lost and a new test will be
              generated if you proceed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
