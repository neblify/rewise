          ...
          <div className="prose max-w-none space-y-8">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              ...
              <li>
                ...
                store, license, sell, or transmit any part of the Service or its
                content without our prior written permission
              </li>
              <li>
                Attempt to gain unauthorized access to, interfere with, damage,
                or disrupt any parts of the Service, the server(s) on which the
                Service is hosted, or any server, computer, or database
              ...
              <li>
                Harass, abuse, threaten, impersonate, or intimidate others
              </li>
              <li>
              ...
              <li>
                ...
                otherwise attempt to discover the source code of the Service
              </li>
            </ul>
            ...
            <p>
              ...
              materials, questions, explanations, layout, design, software,
              etc.) is owned by us or our licensors and is protected by
            ...
            <p>
              We make reasonable efforts to ensure the accuracy of study
              materials and questions. However:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-4">
              <li>
              ...
              <li>
                The Service is <strong>not</strong> an official examination
                board platform
              </li>
              <li>
              ...
              <li>
                Use of the Service does <strong>not</strong> guarantee passing
                any examination
              </li>
            </ul>
            <p className="mt-4">
              You are solely responsible for verifying important information
